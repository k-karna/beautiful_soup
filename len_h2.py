#This program is to find the length of the text
# of the first <h1> tag of a given 
# HTML document
...
print("Length of the text of the first <h1> tag:")
print(len(soup.find('h1').text))
print("Text of the first <h1> tag:")
